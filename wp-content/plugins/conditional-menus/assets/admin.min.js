...
a("#visibility-tabs",e).tabs();a("#visibility-tabs .themify-visibility-inner-tabs",e).tabs()}});return!1}).on("click","#visibility-tabs .themify-visibility-tab",function(b){b.preventDefault();var c=a(this);if(!c.data("active")){b=c.data("type");var h=c.parents("#visibility-tabs").find(".themify-visibility-type-options[data-type="+b+"]"),e=c.parents(".themify-cm-conditions-container").data("item"),e=a(".menu-location-menus[data-item="+e+"] .locations-row-links input").val();a.ajax({url:ajaxurl,type:"post",
data:{action:"themify_create_inner_page",type:b,selected:e},beforeSend:function(){h.html('<div class="tb_slider_loader"></div>')},success:function(a){h.html(a);c.data("active","on")}})}}).on("click",".themify-visibility-pagination .page-numbers",function(b){b.preventDefault();b=a(this);var c=b.parents(".themify-visibility-options"),h=b.parents(".themify-visibility-items-inner"),e=a(".themify-visibility-pagination",h),f=parseFloat(a(".themify-visibility-pagination .current",h).text()),d=1;b.hasClass("next")?
d=f+1:b.hasClass("prev")?d=f-1:b.hasClass("page-numbers")&&(d=parseFloat(b.text()));var g=a(".themify-visibility-items-inner",c);a.ajax({url:ajaxurl,type:"post",data:{action:"themify_create_page_pagination",current_page:d,num_of_pages:h.data("pages")},beforeSend:function(){a(".tb_slider_loader",c).remove();e.hide();g.append('<div class="tb_slider_loader"></div>')},success:function(b){a(".tb_slider_loader",c).remove();a(".themify-visibility-items-page-"+d,h).removeClass("is-hidden");e.html(b).show()}})}).on("click",
".themify-cm-close, #themify-cm-overlay",function(b){b.preventDefault();var c=a(this).parents(".themify-cm-conditions-container");c.animate({top:k()},800,function(){a("#themify-cm-overlay").hide();c.hide().addClass("is-loaded")});return!1}).on("click",".themify-mc-add-assignment",function(b){f(a("#locations-"+a(this).closest("tr").attr("data-menu")).closest("tr"));return!1}).on("click",".themify-cm-save",function(){var b=a(this).parents(".themify-cm-conditions-container"),c=b.data("item"),d=a("form",
b).serialize();g.val(d);a(".menu-location-menus[data-item="+c+"]").val(d);a(".themify-cm-close",b).click();return!1}).on("click",".themify-cm-remove",function(){a(this).closest("tr").fadeOut(function(){a(this).remove()});var b=a(this).closest(".menu-location-menus").data("item");1<a(".menu-location-menus[data-item]").length?a(".themify-cm-conditions-container-"+b).remove():a(".themify-cm-conditions-container").removeClass().addClass("themify-cm-conditions-container themify-admin-lightbox clearfix");
return!1}).on("click",".themify-cm-conditions-container .uncheck-all",function(){a(this).before('<span class="tb_slider_loader_wrapper"><span class="tb_slider_loader"></span></span>');var b=a(this).parents(".themify-cm-conditions-container"),c=b.data("item");a(".menu-location-menus[data-item="+c+"] .locations-row-links input[type=hidden]").val("");a("input:checkbox",b).removeAttr("checked");a(this).parent().find(".tb_slider_loader_wrapper").remove();return!1});a.each(themify_cm.nav_menus,function(b,
c){a("#locations-"+c).closest("tr").after('<tr class="cm-replacement-button" data-menu="'+c+'"><td>&nbsp;</td><td><a href="#" class="themify-mc-add-assignment">'+themify_cm.lang.add_assignment+"</a></td></tr>")});a.each(themify_cm.options,function(b,c){"object"==typeof c&&a.each(c,function(c,e){f(a("#locations-"+b).closest("tr"),c,e.menu,e.condition);d[b]=++c})});a("#themify-cm-about").appendTo("p.button-controls")});
